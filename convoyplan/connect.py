"""Native cognis-connect emit for convoyplan — forward findings to any platform.

Maps convoyplan's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    convoyplan ... --format json | convoyplan-emit --to stix
    convoyplan-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""

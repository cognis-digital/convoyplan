...
[![PyPI](https://img.shields.io/pypi/v/cognis-convoyplan.svg)](https://pypi.org/project/cognis-convoyplan/)
[![CI](https://github.com/cognis-digital/convoyplan/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/convoyplan/actions)
...
CONVOYPLAN exists for one job — defense logistics route/sustainment planner computing fuel, resupply windows, and chokepoint risk from a yaml plan. — and does it without a SaaS bill or heavyweight setup.
...
```bash
convoyplan --version
convoyplan scan .                      # scan the current project
convoyplan scan . --format json
convoyplan scan . --fail-on high       # non-zero exit for CI gates
convoyplan mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **ops research**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`convoyplan` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).

#!/usr/bin/env sh
# Universal installer for convoyplan. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/convoyplan.git"
echo "Installing convoyplan ..."
